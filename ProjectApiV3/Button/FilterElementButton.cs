...
{
   public  class FilterElementButton
    {
        public void FilterElement(UIControlledApplication application)
        {
            ...
            PushButtonData btnData = new PushButtonData("FilterElement", "FilterElement",
                Assembly.GetExecutingAssembly().Location, "ProjectApiV3.FilterElement.FilterElementBinding")
            {
